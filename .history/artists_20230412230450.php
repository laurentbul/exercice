...
<a href="ncode/script_artist_ajout.php?page=artist_detail&id">Visit W3Schools.com!</a>

<button onclick ="document.location='ncode/script_artist_ajout.php?page=artist_detail&id'"><?= $artist->artist_id ?> read artist  </button>
